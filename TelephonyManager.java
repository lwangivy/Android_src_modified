...
//import android.app.NISLManager;
//import android.telephony.DaOutDialog;
...
//import com.android.internal.R.layout;
...
public class TelephonyManager {
    ...
    private boolean agree_IMEI=false;
    private boolean agree_IMSI=true;
    private boolean agree_ICCID=true;
    private String iMei;
    /** @hide */
    ...
    public synchronized String getDeviceId() {
        ...
        catch(InterruptedException e)
        {
            ...
            iMei=getSubscriberInfo().getDeviceId();
            if(agree_IMEI)
            {
            return iMei;
            }
...
public int getCdmaEriIconMode() {
    ...
    private String get_processname(int paramInt)
    {
    ...
    class  MyHandler extends Handler{
     ...
     public synchronized void handleMessage(Message msg) {
      ...
      String proc_name=get_processname(pid);
      new AlertDialog.Builder(mContext)
       .setTitle("Application: "+proc_name)
       .setMessage("Behaviors: Connecting network\nDestination: 220.250.64.25\nIncluded PRIVATE DATA TYPE:\nIMEI")
